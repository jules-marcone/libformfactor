...
//
//! @file      demo/pave.cpp
//! @brief     Computes the formfactor of a rectangular prism
//!
//! @homepage  https://github.com/jules-marcone/libformfactor
//! @license   GNU General Public License v3 or higher (see LICENSE)
//! @copyright Forschungszentrum Jülich GmbH 2022
//! @author    Jules Marcone, Jules 2022
//
//  ************************************************************************************************
...
int main()
{
    std::cout << "# Pave form factor, for different q scans\n";
    ff::cuboid::Pave pave(1., 2., 3.);
    ...
    for (double t = 0.2; t < 200; t *= 1.002) {
        ...
        std::cout << t << " " << std::abs(pave.formfactor(q)) << std::endl;
    }
    std::cout << std::endl;
